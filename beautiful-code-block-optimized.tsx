/**
 * Beautiful Code Block Component - Size Optimized
 * 
 * A feature-rich, size-optimized code display component for React/Next.js applications
 ...
 * 
 * Size Optimizations:
 * • Simplified language icons (90% smaller)
 * • Condensed theme configuration (50% smaller)
 * • Streamlined animations and badge system
 * • Reduced dependency on heavy utility functions
 * 
 * Installation:
 ...
 * 3. Import and use: import { CodeBlock } from './beautiful-code-block-optimized'
 * 
...
const getBadgeClasses = ({ variant = "default", customColor, customClass }: TBadgeProps): string => {
  ...
  if (variant === "custom") {
    return customClass 
      ? `${base} ${customClass}` 
      : `${base} bg-gradient-to-r from-pink-500 to-purple-500 text-white border border-pink-500/30`;
  }
...
/**
 * Beautiful Code Block Component - Optimized for Size
 * 
