...
export function Badge({ variant = 'default', customColor, children }: BadgeProps) {
  ...
  const variantClasses = {
    ...
    custom: customColor ? `border border-${customColor}-500/30 bg-${customColor}-500/10 text-${customColor}-400 hover:border-${customColor}-400 hover:text-${customColor}-300` : "",
  };
