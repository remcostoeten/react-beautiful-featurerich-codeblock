...
type SupportedLanguage = 'javascript' | 'typescript' | 'python' | 'rust' | 'sql' | 'other';

const languageOptions: { value: SupportedLanguage; label: string; icon: JSX.Element }[] = [
  { value: 'javascript', label: 'JavaScript', icon: <Icons.JavascriptIcon size={16} /> },
  { value: 'typescript', label: 'TypeScript', icon: <Icons.TypescriptIcon size={16} /> },
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="badgeVariant" className="block text-sm font-medium text-gray-400 mb-1">
              Badge Variant
            </label>
            <select
              id="badgeVariant"
